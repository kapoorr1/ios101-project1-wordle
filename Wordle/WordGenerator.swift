...
class WordGenerator {
  ...
  static let possibleWords = ["ABOUT", "PIANO", "HOUSE", "ALONE", "ABOVE", "MEDIA", "RADIO", "VOICE", "VALUE", "ALIVE", "OCEAN", "IMAGE", "OLIVE", "QUIET", "VIDEO", "CAUSE", "SAUCE", "MOVIE", "JUICE", "NOISE", "ABUSE", "OPERA", "NAIVE", "EMAIL", "AZURE"]
